...
# %%
f=open("NLMRSVMCausalLinear.txt","a")
...
link="/data/users/cs20s037/CITNonLinear/LinearDifferentvalues/testing_writingvalues_Linear0to1.txt"
...
def stratify_B_n_times_diff(L,A,B,n):
    ...
    for i in range(0,n):
        ...
        loss.append(sum(abs(y_pred_zeros-y_pred_ones)/1000))
    return loss
