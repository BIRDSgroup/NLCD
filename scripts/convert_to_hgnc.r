...
{
causalpair<-read.table(data,sep=',',header=TRUE)
...
write.csv(convert_hgnc("./results/journal/human_muscle/nlcd/causal.csv"),"./results/journal/human_muscle/nlcd/causal_converted.csv",row.names = FALSE)
write.csv(convert_hgnc("./results/journal/human_muscle/nlcd/causal_rev.csv"),"./results/journal/human_muscle/nlcd/causal_rev_converted.csv",row.names=FALSE)
