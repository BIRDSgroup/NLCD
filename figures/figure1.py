...
for i in ['Linear','Sine','Saw']:
    for j in ['300','500','1000']:
        precision_nlmr_SVR,recall_nlmr_SVR= calculate_precision_recall("./../results/figure1/"+i+"SVR"+j+"s100perm.txt","./../results/figure1/IndpSVR"+j+"s100perm.txt")
        precision_nlmr_ANN,recall_nlmr_ANN= calculate_precision_recall("./../results/figure1/"+i+"ANN"+j+"s100perm.txt","./../results/figure1/IndpANN"+j+"s100perm.txt")
        precision_nlmr_KRR,recall_nlmr_KRR= calculate_precision_recall("./../results/figure1/"+i+"KRR"+j+"s100perm.txt","./../results/figure1/IndpKRR"+j+"s100perm.txt")
        precision_CIT,recall_CIT= calculate_precision_recall("./../results/figure1/"+i+j+"cit.csv","./../results/figure1/Indp"+j+"cit.csv",iscit=True)
        fig, ax = plt.subplots()
        ...
        ax.legend( loc="best")
        ax.set_title("P-R curve for "+i+" data No of samples="+j)
        plt.savefig("./prcurve"+i+j+".png")
